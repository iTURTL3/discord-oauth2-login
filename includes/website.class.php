...
class website {
   ...
   */
   ...
   public static function discord_auth($client_id, $client_secret, $scopes, $code) {
      $request = self::http_request('https://discordapp.com/api/oauth2/token', http_build_query(array(
   ...
   public static function discord_user_info($token) {
      $request = self::http_request('https://discordapp.com/api/users/@me', false, array(
